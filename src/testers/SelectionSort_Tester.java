...
public class SelectionSort_Tester {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(SelectionSort.doSelectionSort(numbers, results)));
		// Display details 
		...
		// Print original array
				...
				System.out.println("**************************************");
		// Print and sort array
		System.out.println(Arrays.toString(SelectionSort.doSelectionSort(ascendingArray, results)));
		// Display details 
		System.out.println("Time taken: " + results.time +"ms");
		System.out.println("Swaps: " + results.numberOfSwaps);
		System.out.println("Comparisons: " + results.numberOfComparisons);	
		...
		System.out.println("**************************************");
		// Print and sort array
		System.out.println(Arrays.toString(SelectionSort.doSelectionSort(descendingArray, results)));
		// Display details 
		System.out.println("Time taken: " + results.time +"ms");
		System.out.println("Swaps: " + results.numberOfSwaps);
		System.out.println("Comparisons: " + results.numberOfComparisons);
